...
const ClothSlide = () => {
	return(
		<div className="bg-skin-third h-full relative">
          <img src={first} className="object-cover object-left w-full h-full" alt="" />

          <div className="absolute z-30 top-0 flex items-center lg:justify-end md:justify-center w-full h-full bg-gray-800/60">
          	<div className='lg:w-[30rem] md:w-[25rem] lg:me-12 md:me-0  text-center text-lg text-skin-sixth/90 font-light'>

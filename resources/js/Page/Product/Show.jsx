				...
				{!error && Object.keys(data).length > 0 && (
					<section>
						<div className="flex sm:p-10 p-8 flex-col md:flex-row">
							...
							<div className="flex-none lg:w-[30rem] lg:h-auto sm:w-[20rem] flex justify-center mb-8 md:mb-0">
								<div className="lg:w-[25rem] lg:h-fit md:w-[16rem] md:h-[20rem] w-[20rem] h-[25rem]">
									<img 
								     	src={data.image} 
								     	alt="" 

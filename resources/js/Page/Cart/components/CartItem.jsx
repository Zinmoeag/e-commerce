...
import {removerCartItem, increseQuantity, decreaseQuantity} from '../../../Redux/index'
...
const CartItem = ({cartItem}) => {
	...
	return (
		<div className="sm:h-[6rem] h-[20rem] bg-white  rounded-lg border-slate-400 overflow-hidden flex flex-col sm:flex-row sm:text-md text-sm relative">
			...
			<div className="grid sm:grid-cols-5 grid-cols-4 w-full">
				...
				<div className="col-span-1 flex flex-col justify-center">
					<div className="flex">
						...
						<div className="w-8 text-center">{cartItem.quantity}</div>
						<button 
							className="bg-slate-800 text-white w-6"
